...
import com.zbinyds.rabc.mapper.RoleMapper;
import com.zbinyds.rabc.pojo.UserRole;
import com.zbinyds.rabc.service.RoleService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.zbinyds.rabc.service.UserRoleService;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements RoleService {
    ...
    public Map<String, Object> findRoleByUserId(String userId) {
        ...
        roleMap.put("assignRoles", assignRoles); // 已分配的角色列表
        roleMap.put("allRolesList", allRolesList); // 所有的角色列表
        return roleMap;
    }
